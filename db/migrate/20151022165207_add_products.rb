class AddProducts < ActiveRecord::Migration
  def change
  	...
  	Product.create :title => 'Vegeterian', :description => 'Amazing Vegeterian pizza', :price => 400, :size => 30, :is_spicy => false, :is_veg => true, :is_best_offer => false, :path_to_image => '/images/veg.jpg'
  end
end
